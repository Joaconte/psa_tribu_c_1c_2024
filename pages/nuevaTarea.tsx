  ...
  return (
    ...
    <div className="mt-8 flex h-full flex-col space-x-0 space-y-4 bg-white">
      ...
      <div className="container max-w-7xl mx-auto mt-8 space-y-7">
        ...
        <form class="max-w-sm">
          <label for="countries" class="block mb-2 text-sm font-medium text-gray-900">Desarrollador designado</label>
        ...
        <div className="flex justify-center items-center bg-white space-x-10">
          ...
          dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Crear nueva tarea</button>
        </div>
      </div>
    </div>
  )
